...
{
    Task<ActionResult<PaginationResponse<long, TEntity>>> Query(HttpContext context, ClaimsPrincipal user,
                                                                Func<Expression<Func<TEntity, bool>>?,
                                                                    Task<ActionResult<
                                                                        PaginationResponse<long, TEntity>>>> query);
